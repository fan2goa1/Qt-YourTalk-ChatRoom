...
public:
    ...
    void addMessageToTextEdit(QString str,QNChatMessage::User_Type type);
    void addMessageToTextEdit_document(QString filename,QNChatMessage::User_Type type);
    void addMessageToTextEdit_photo(QString filename,QNChatMessage::User_Type type);
    void addMessageToTextEdit_emoj(QString filename,QNChatMessage::User_Type type);
    void addMessageToTextEdit_headphoto(QString filename,QNChatMessage::User_Type type);
