...
void Groupchat_windows::on_pushButton_clicked()
{
    ...
    this->addMessageToTextEdit(message,QNChatMessage::User_Me);
...
void Groupchat_windows::addMessageToTextEdit(QString str,QNChatMessage::User_Type type)
 {
     QString msg = str;
     ...
     if(type==QNChatMessage::User_Me)
     {
         if(isSending)
         {
             ...
             QString str_left=returnPhotoPath();
             QString str_right=returnPhotoPath();
...
QString Groupchat_windows::returnPhotoPath()
{
