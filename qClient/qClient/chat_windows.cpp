...
void Chat_windows::on_Send_clicked()
{
    ...
    this->addMessageToTextEdit(message,QNChatMessage::User_Me);//添加消息
    ui->textEdit->clear();
}
...
void Chat_windows::on_send_file_clicked()
{
    //初始化操作
     ...
     this->addMessageToTextEdit_document(filename,QNChatMessage::User_Me);//添加消息
...
void Chat_windows::on_send_img_clicked()
{
    //初始化操作
     ...
     this->addMessageToTextEdit_photo(filename,QNChatMessage::User_Me);//添加消息
...
void Chat_windows::addMessageToTextEdit_document(QString filename,QNChatMessage::User_Type type)
{
...
void Chat_windows::addMessageToTextEdit_photo(QString filename,QNChatMessage::User_Type type)
{
...
void Chat_windows::addMessageToTextEdit(QString str,QNChatMessage::User_Type type)
{
    QString msg = str;
...
void Chat_windows::addMessageToTextEdit_emoj(QString str,QNChatMessage::User_Type type)
{
    QString msg = str;
...
void Chat_windows::click_exp(QString message)
{
    ...
    tcpSocket->write(str.toUtf8().data());
    this->addMessageToTextEdit_emoj(Filename,QNChatMessage::User_Me);//添加消息
}
