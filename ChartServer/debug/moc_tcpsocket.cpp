...
void TcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpSocket::sig_disconnect)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TcpSocket::*_t)(int , const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpSocket::sig_readyRead)) {
                *result = 1;
                return;
            }
        }
